...
The mean rate of the spike and post-spike periods are markedly higher than the pre-spike period, suggesting that the surge in car thefts in 2023 did lead to a sustained higher rate of car theft in Prince George's County.
...
This chart visualizes the car theft rate per 100,000 people by month, from 2017 to 2025. The chart displays a significant uptick in 2023, denoted by the red lines and label "Spike Year." 

Title: "Prince George's County Car Theft Rate Spiked in 2023 and Remained High"
...
- **Null Hypothesis (H0)**: There is not significant difference in the car theft rate during the pre-spike period (pre-2023), spike period (2023), and post-spike period (2024-present).

- **Alternative Hypothesis (H1)**: There is significant difference in the car theft rate during the pre-spike period (pre-2023), spike period (2023), and post-spike period (2024-present).
...
As signified by the F-value of 218, there are real differences between in the average rates between the three time periods. These differences between the periods are much greater than the differences within the periods, meaning the between-period differences are statistically significant.
...
As evidenced by the results of the Tukey test, there are at least double-digit differences between the car theft rates in all three periods. The largest difference is between the pre-spike period and spike period, with the car theft rate during the spike period being between 32 and 41 thefts higher. The chart featuring confidence intervals clearly shows that the theft rate during the post-spike period is noticeably higher than the rate during the pre-spike period.

HL: "Prince George's County car theft rates remain high in years after 2023 spike"

Lede: A 2023 surge in car thefts in Prince George's County has lingered in the two years since, with theft rates remaining far above pre-2023 metrics.
