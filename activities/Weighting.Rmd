...
The weights in this dataset range from about 0.23 to about 3.04.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

A weight of 0.23 means the respondent is overrepresented and extremely common in the sample, while a weight of 3.04 means the respondent is underrepresented and their demographic is very rare in the sample.

3. Why might some respondents be weighted more heavily than others?

Some respondents are weighted more heavily than others because they would be underrepresented in the sample and their response would be undervalued because of the low number of respondents with a similar identity.
...
The "rarely/never" category showed the biggest difference between weighted and unweighted results.

2. How might these differences affect reporting on likely voter turnout?

If a poll predicts voter turnout using unweighted results, they may underestimate how many voters that rarely or never vote will vote in the upcoming election.
...
The differences in weighted and unweighted numbers exist because of how strongly the "rarely/never" category is weighted. This demographic is underrepresented, leading to them being weighted more strongly than the "always" or "sporadic" groups. Thus, there is a larger difference between weighted and unweighted results for the "rarely/never" group.
