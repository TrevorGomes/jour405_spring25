...
The average, both mean and median, SAT scores for community colleges are considerably lower than those at private and public universities, while also having the largest standard deviation. Scores at private institutions are also noticeably higher than scores at public universities. Scores at private colleges are the most clustered as well, with a lower standard deviation than the two other types of colleges.
...
There are significant differences in SAT scores across college types as evidenced by the F-value yielded by our ANOVA test. An F-value of 284.3 shows that the variance between groups is much greater than the variance within groups. Along with a low p-value, showing that the results are statistically significant, these results show that scores vary considerably across college types.

2. Which specific college types differ from each other?

All three college types differ from each other, but community college scores are by far the lowest. Public scores are also lower than scores at private colleges.

3. How large are these differences?

The SAT scores in our sample from private universities were, on average, 366.96 points higher than those from community colleges. Public scores were 292.55 points higher than community college scores and 74.4 points lower than private scores, on average.
...
HL: "Students admitted to private universities scored higher on SAT than public, community colleges"

Students at private institutions had higher average SAT scores than students attending public universities or community colleges, according to a recent analysis of a sample of 300 scores. On average, scores from private universities were about 367 points higher than community college scores and roughly 74 points higher than scores from public colleges.
