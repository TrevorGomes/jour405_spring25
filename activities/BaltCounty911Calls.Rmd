...
A pair of days in early October 2022 and January 2023 are quite unusual, as well as a few days other days hovering at or above 20 911 calls. I would also classify any days with 5 or less calls as unusual. 
...
This visualization highlights a greater number of statistically unusual days than I did in my answer to Task 3. I defined an usual day as 20 or more calls, while this visualization displays days with about 18 or more calls as unusual.
...
October 4, 2022, had 23 911 calls for overdoses, which is especially unusual given that day was a Tuesday. That date had the largest deviation from the average number of calls on Tuesdays.
...
A significant finding is that the average number of 911 overdose calls dips in September, which coincides with children going back to school. The next steps would be to investigate whether these two factors are correlated. I would also explore who is making the largest number of calls, whether it is mostly minors calling on behalf of other minors overdosing, or children calling for an adult's overdose. I would tell my editor about this general trend, and about my next steps to investigate this trend further.
