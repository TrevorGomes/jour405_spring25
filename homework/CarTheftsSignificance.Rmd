...
There was a steady decline in Prince George's County car thefts from July 2023, then a slight rise in early 2024, before monthly car thefts once again steadily decreased until modern day (2025).
...
Now that the data is visualized, it's clearer that July 2023 and January 2025 are outliers, as they strongly deviate from the mean. In the past two months, car thefts have rapidly decreased, but in the roughly eight months prior, the number hovered around the mean. 
...
The confidence interval upper and lower bounds are quite broad, ranging from 415 to about 505, meaning that the mean could range within those values. The mean likely most accurately represents the average number of car thefts in a typical month because it falls in between the upper and lower bounds of the confidence interval. 

HL: "Prince George's County car thefts trending downwards in past five months"
...
Our hypothesis test yielded a p-value of 0.179, considerably higher than the threshold of 0.05 to be considered statistically significant. Based on this p-value, we cannot reject the null hypothesis. I would not revise my headline from Task 6 because this test compared the first and second half of the data set, which includes 10 months in each period. My headline only pertains to the past five months. I would tell my editor that the data set provides worthwhile data and a newsworthy story for the past five months, but the rest of the data set is not necessarily viable. I would expect my editor to ask me to explain why the rest of the data set is not statistically significant and should not be considered for my story.
