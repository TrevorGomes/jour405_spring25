...
Data suggests that the new light rail line has likely increased home values. There is a 95% chance, indicated by a 95% confidence level, that the average cost of homes since the transit line opened have increased. The mean cost of new properties is most likely between roughly $298,000 and $311,000, up from $285,000, the previous average cost of homes before the rail extension opened. A sample of 14 homes were taken, and all were purchased for over $285,000.
