...
The correlation coefficient is nearly zero, showing that there is an extremely weak (if any) relationship between goal differential and fouls committed. The scatterplot also displays no clear relationship between goal differential and fouls, nearly displaying a "normal distribution." Fouls committed are lower at both ends of goal differential, showing that winning or losing by a wide margin is largely unrelated to fouls.
